...
folder_path = ("C:\\Users\\Public\\Documents\\Tampereen yliopisto\\"+
               "Eye tracker\\TRE Cohort 2\\gazeAnalysisLib analyses\\"+
               "testing 7mo,trec2")#("D:\\lasayr\\Aaltonen\\mi") #+ folder_name)

# create new DataFolder to be inspected/processed
data_folder = DataFolder(folder_path, limit_rows = None, limit_files = None)
